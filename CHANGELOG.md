...
- Readers for players, contracts, suspensions, clubs, managed clubs, stages, competitions and fixtures: `Save.players()`, `Save.contracts()`, `Save.suspensions()`, `Save.clubs()`, `Save.managed_clubs()`, `Save.stages()`, `Save.competitions()` and `Save.fixtures()`.
